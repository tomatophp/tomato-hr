...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.employee-payments.index",
           "admin.employee-payments.api",
           "admin.employee-payments.create",
           "admin.employee-payments.store",
           "admin.employee-payments.show",
           "admin.employee-payments.edit",
           "admin.employee-payments.update",
           "admin.employee-payments.destroy",
           "admin.employee-payments.export",
           "admin.employee-payments.bulk",
