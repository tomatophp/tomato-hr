...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.employee-applies.index",
           "admin.employee-applies.api",
           "admin.employee-applies.create",
           "admin.employee-applies.store",
           "admin.employee-applies.show",
           "admin.employee-applies.edit",
           "admin.employee-applies.update",
           "admin.employee-applies.destroy",
           "admin.employee-applies.export",
           "admin.employee-applies.bulk",
