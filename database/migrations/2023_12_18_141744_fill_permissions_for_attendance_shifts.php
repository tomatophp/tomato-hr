...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
           ...
           "admin.attendance-shifts.api",
           "admin.attendance-shifts.create",
           "admin.attendance-shifts.store",
           "admin.attendance-shifts.show",
           "admin.attendance-shifts.edit",
           "admin.attendance-shifts.update",
           "admin.attendance-shifts.destroy",
           "admin.attendance-shifts.export",
           "admin.attendance-shifts.bulk",
