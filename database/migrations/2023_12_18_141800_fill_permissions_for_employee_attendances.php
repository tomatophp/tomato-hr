...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.employee-attendances.index",
           "admin.employee-attendances.api",
           "admin.employee-attendances.create",
           "admin.employee-attendances.store",
           "admin.employee-attendances.show",
           "admin.employee-attendances.edit",
           "admin.employee-attendances.update",
           "admin.employee-attendances.destroy",
           "admin.employee-attendances.export",
           "admin.employee-attendances.bulk",
