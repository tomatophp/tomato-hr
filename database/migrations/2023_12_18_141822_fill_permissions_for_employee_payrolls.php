...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.employee-payrolls.index",
           "admin.employee-payrolls.api",
           "admin.employee-payrolls.create",
           "admin.employee-payrolls.store",
           "admin.employee-payrolls.show",
           "admin.employee-payrolls.edit",
           "admin.employee-payrolls.update",
           "admin.employee-payrolls.destroy",
           "admin.employee-payrolls.export",
           "admin.employee-payrolls.bulk",
