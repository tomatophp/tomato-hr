...
return new class extends Migration
{
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
                       "admin.employee-requests.index",
           "admin.employee-requests.api",
           "admin.employee-requests.create",
           "admin.employee-requests.store",
           "admin.employee-requests.show",
           "admin.employee-requests.edit",
           "admin.employee-requests.update",
           "admin.employee-requests.destroy",
           "admin.employee-requests.export",
           "admin.employee-requests.bulk",
