<x-tomato-admin-container label="{{trans('tomato-admin::global.crud.create')}} {{__('Employee')}}">
    <x-splade-form class="flex flex-col space-y-4"  action="{{route('admin.employees.store')}}" method="post" :default="['national_id_type'=> 'national_id', 'links' => [], 'documents' => [], 'salary_period'=>'monthly']">
          ...
          <div class="grid grid-cols-3 gap-4">
              ...
              <x-splade-select choices :label="__('Salary period')" name="salary_period" type="text"  :placeholder="__('Salary period')">
